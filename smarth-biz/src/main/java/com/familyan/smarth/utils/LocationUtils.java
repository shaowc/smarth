...
public class LocationUtils {
    ...
    /**
     * 根据两点间经纬度坐标（double值），计算两点间距离，带单位
     *
     * @return
     */
    public static String getDistanceWithUnit(double lng1, double lat1, double lng2, double lat2) {
        double miles = getDistance(lng1, lat1, lng2, lat2);
        if(miles > 1000) {
            return (miles / 1000) + "km";
        } else {
            return miles + "m";
        }
    }
