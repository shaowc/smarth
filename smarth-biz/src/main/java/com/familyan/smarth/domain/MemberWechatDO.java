...
/**
 * @author 		yyc
 * @see	         	数据库表名：MEMBER_WECHAT
 * @generate 	    2016-04-09 14:03:56
 */
public class MemberWechatDO implements Serializable {

    private static final long serialVersionUID = 315280430276200L;
